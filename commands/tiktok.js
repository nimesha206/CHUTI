    ...
    try {
        ...
        if (!text) {
            return await sock.sendMessage(chatId, { 
                text: "කරුණාකර ටික්ටොක් වීඩියෝවේ ලින්කුව ලබාදෙන්න."
            });
        }
        ...
        if (!url) {
            return await sock.sendMessage(chatId, { 
                text: "කරුණාකර ටික්ටොක් වීඩියෝවේ ලින්කුව ලබා දෙන්න."
            });
        }
        ...
        if (!isValidUrl) {
            return await sock.sendMessage(chatId, { 
                text: "වැරදි ලිංකුවකි. කරුණාකර නිවැරදි ලිංකුව ලබා දෙන්න."
            });
        }
        ...
        try {
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `Downloaded By Chuti\n\n📝 Title: ${title}` : "Downloaded By Chuti";
