...
> © ᴄʜᴜᴛɪ ᴡᴀ ʙᴏᴛ | ɴɪᴍᴇsʜᴀ ᴍᴀᴅʜᴜsʜᴀɴ
    ...
    // ඔයා දුන්න නිවැරදි Main Image Link එක මෙන්න
    const imageUrl = "https://ibb.co/zWRYD9sr";
    ...
    await sock.sendMessage(
      chatId,
      {
        image: { url: imageUrl },
        caption:
          `📖 *බයිබලයේ ඇති පොත් ලැයිස්තුව*:\n\nමෙන්න බයිබලයේ අඩංගු සම්පූර්ණ පොත් ලැයිස්තුව:\n\n${bibleList}`,
        contextInfo: {
            forwardingScore: 1,
            isForwarded: true,
    ...
    await sock.sendMessage(
      chatId,
      { text: "❌ *ලැයිස්තුව ලබා ගැනීමේදී දෝෂයක් සිදු විය. පසුව උත්සාහ කරන්න.*" },
      { quoted: message }
    );
  }
}
